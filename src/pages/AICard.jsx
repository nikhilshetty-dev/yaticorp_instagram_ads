...
const heroTrustPoints = [
  ...
  "Beginner-friendly • Any background",
];
    ...
    <div className="bg-[#0b1320] text-slate-100 pb-24 sm:pb-0">
        ...
        <div className="relative z-10 max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="mt-6">
              ...
              <AnimatedHeading text="at just ₹500" />
            </div>
            ...
            <p className="mt-6 text-base md:text-lg text-slate-200 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Build practical AI & Data skills with 50+ tools, Power BI, Tableau, internships, scholarships and career
              guidance - all in one program.
            </p>
            ...
            <div className="mt-4 flex items-center justify-center lg:justify-start">
              <span
                className="inline-flex items-center rounded-lg border border-amber-300/40 bg-amber-300/15 px-3 py-1.5 text-xs sm:text-sm font-semibold text-amber-200 text-center lg:text-left leading-tight"
                aria-label="No hidden charges, one-time payment, lifetime access"
              >
                No Hidden Charges • One-time Payment • Lifetime Access
              </span>
            </div>
      ...
      <section className={`px-4 sm:px-6 py-14 ${sectionBg.deep} border-y border-[#d7e4ff]`}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            className={`${cardStyle} rounded-2xl p-3`}
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-blue-100 to-cyan-100 border border-[#d7e4ff] rounded-2xl p-8">
            ...
            <p className="text-slate-700 mt-3 leading-relaxed">
              Choose your preferred language and continue learning without friction. The same curriculum is available in both tracks.
            </p>
          </div>
          ...
          <div className="rounded-[28px] border border-white/20 bg-gradient-to-br from-[#3b66e2] via-[#2f55c6] to-[#25439c] p-4 sm:p-8 lg:p-10 shadow-[0_30px_80px_-28px_rgba(28,53,138,0.65)]">
            <div className="grid items-center gap-8 lg:grid-cols-[1.15fr_1fr] lg:gap-12">
              ...
              <div className="text-center text-white lg:text-left">
                ...
                <h2 className="text-3xl font-bold leading-tight sm:text-4xl md:text-5xl">AI Professional Certificate</h2>

                <p className="mt-4 text-xl text-blue-100 sm:text-2xl">Industry-recognized certification from Yaticorp</p>
